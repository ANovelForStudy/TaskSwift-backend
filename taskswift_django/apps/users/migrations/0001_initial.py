        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "user_type",
                    models.CharField(
                        choices=[("1", "Работник"), ("2", "Руководитель"), ("3", "Администратор")],
                        default=1,
                        max_length=1,
                ...
                (
                    ...
                    phonenumber_field.modelfields.PhoneNumberField(
                        blank=True, max_length=128, region=None, unique=True, verbose_name="Номер телефона"
                    ),
                ),
                ...
                (
                    ...
                    models.CharField(
                        blank=True, max_length=100, verbose_name="Имя контактного лица для экстренных случаев"
                    ),
                ),
                (
                    "emergency_contact_phone",
                    phonenumber_field.modelfields.PhoneNumberField(
                        blank=True, max_length=20, region=None, verbose_name="Телефон для экстренных случаев"
                    ),
                ),
